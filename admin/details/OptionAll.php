...
<head>
    ...
    <title>Option Wise</title>
    <link rel="icon" href="../../assets/logo.png">
</head>

<body>
    <h1 style="text-align: center; margin-top: 5%;">Option Wise List</h1>
    <?php
...
{
    $count = 1;
    $result = mysqli_query($con, "SELECT * FROM idc_result WHERE $option = $courseID  ORDER BY attendence desc");
